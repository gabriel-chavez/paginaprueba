...
$domain = "https://" . $_SERVER['HTTP_HOST'] ."/soat";

$urls = array(1 => "inicio", 2 => "guia-de-atencion-de-su-siniestro", 3=>"precios", 4=> "puntos-de-venta", 5=> "formulario-soat", 6 => "consulta-para-verificación-de-vigencia-de-soat", 7 => "puntos-de-venta?p=1", 8 => "contactanos");
