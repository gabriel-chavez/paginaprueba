		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-md-12 copyright">
					<p class="pull-left">&copy; Sintic Bolivia <?php print date('Y')?>. Todos los derechos reservados.</p>
					<p class="pull-right"><a href="#" title="Univida Template"><?php print SITE_TITLE; ?></a></p>
				</div>
			</div>
		</div>
	</div>
