	...
	<div class="row">
		<div class="col-md-6">
			<div class="panel panel-default">
				...
				<div class="panel-body" style="height:350px;overflow-x:none;overflow-y:auto;">
					<ul class="list-group">
					...
					<li class="row list-group-item" 
						...
						data-link="<?php print SB_Route::_('index.php?mod=content&view=article&id='.$p->content_id, 'frontend'); ?>"
						data-type="page">
						<div class="col-md-10"><?php print $p->title; ?></div>
						<div class="col-md-2"><a href="javascript:;" class="btn btn-default btn-add-page"><?php _e('Add', 'menu'); ?></a></div>
					</li>
					<?php endforeach; ?>
					</ul>
				</div>
			...
			<div class="panel panel-default">
				...
				<div class="panel-body" style="height:350px;overflow-x:none;overflow-y:auto;">
					...
					<li class="row list-group-item" 
						...
						data-link="<?php print SB_Route::_('index.php?mod=content&view=section&id='.$s->section_id, 'frontend'); ?>"
						data-type="section">
			...
			<div class="panel panel-default">
				...
				<div class="panel-body" style="height:350px;overflow-x:none;overflow-y:auto;">
					...
					<li class="row list-group-item" 
						...
						data-title="<?php print $p->title; ?>"
						data-slug="<?php print $p->slug; ?>"
						data-link="<?php print SB_Route::_('index.php?mod=content&view=post&id='.$p->content_id, 'frontend'); ?>"
						data-type="post">
						<div class="col-md-10"><?php print $p->title; ?></div>
						<div class="col-md-2"><a href="javascript:;" class="btn btn-default btn-add-page"><?php _e('Add', 'menu'); ?></a></div>
					</li>
			...
			<div class="panel panel-default">
				...
				<div class="panel-body" style="height:350px;overflow-x:none;overflow-y:auto;">
					...
					<li class="row list-group-item" 
						...
						data-link="<?php print SB_Route::_('index.php?mod=content&view=category&id='.$c->category_id, 'frontend'); ?>"
						data-type="category">
					...
					<ul id="menu-items">
						...
						<li class="menu-item" data-id="<?php print $item->id; ?>" 
							...
							<div class="data">
								...
								<div class="form-group">
									<input type="text" name="title" value="<?php print $item->title; ?>" class="form-control menu-item-title" draggable="false" />
								</div>
								<div class="form-group">
									<input type="text" name="link" value="<?php print @$item->link; ?>" class="form-control menu-item-link" draggable="false" />
								</div>
								<div class="form-group">
									<a href="javascript:;" class="btn btn-default btn-remove-item"><?php _e('Remove', 'menu'); ?></a>
								</div>
							</div>
							<ul class="sub-menu">
								...
								<li class="menu-item" data-id="<?php print $ii->id; ?>" 
									...
									<div class="data">
										<h4><?php _e('Menu Data', 'menu'); ?></h4>
										<div class="form-group">
											<input type="text" name="title" value="<?php print $ii->title; ?>" class="form-control menu-item-title" draggable="false" />
										</div>
										<div class="form-group">
											<input type="text" name="link" value="<?php print @$ii->link; ?>" class="form-control menu-item-link" draggable="false" />
										</div>
										<div class="form-group">
											<a href="javascript:;" class="btn btn-default btn-remove-item"><?php _e('Remove', 'menu'); ?></a>
										</div>
	...
	function menu_add_page(data)
	{
		...
		var li = '<li class="menu-item">'+
					...
					'<div class="data">'+
						'<h4>Menu Data</h4>'+
						'<div class="form-group">'+
							'<input type="text" name="title" value="'+data.title+'" class="form-control menu-item-title" draggable="false" />'+
						'</div>'+
						'<div class="form-group">' +
							'<a href="javascript:;" class="btn btn-default btn-remove-item"><?php _e('Remove', 'menu'); ?></a>'+
						'</div>' +
