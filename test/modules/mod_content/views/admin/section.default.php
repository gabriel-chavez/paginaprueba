...
?>
<div class="wrap">
	<h1><?php print SB_Text::_('Secciones', 'content'); ?></h1>
	<ul class="view-buttons">
		<li>
			<a class="btn btn-secondary has-popover" href="<?php print SB_Route::_('index.php?mod=content&view=section.new'); ?>"
	...
	<tr>
		...
		<td>
			<a href="<?php print SB_Route::_('index.php?mod=content&view=section.edit&id='.$s->section_id); ?>" class="btn btn-default"
				title="<?php print SB_Text::_('Editar', 'content'); ?>">
				<span class="glyphicon glyphicon-edit"></span>	
			</a>
			<a href="<?php print SB_Route::_('index.php?mod=content&task=section.delete&id='.$s->section_id); ?>" class="confirm btn btn-default"
