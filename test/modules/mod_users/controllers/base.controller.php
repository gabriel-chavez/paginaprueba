...
abstract class LT_ControllerUsersBase extends SB_Controller
{
	public function task_recover_pwd_now()
	{
		...
		$message 	= sprintf(__("Hello %s %s<br/><br/>"), $user->first_name, $user->last_name);
		...
		$message 	.= __("If you does not requested your password, please ignore this email.<br/>", 'users');
		...
		$mail->send();
		SB_MessagesStack::AddMessage(SBText::_('Revise su email y siga las intrucciones para recuperar su contraseña.'), 'success');
