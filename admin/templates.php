					...
					<div class="template panel panel-default">
						...
						<div class="panel-body">
					  	...
					  	<div class="panel-footer">
					  		<a href="<?php print SB_Route::_('templates.php?type='.$type . '&activate=' . $id); ?>" class="btn btn-default"><?php print SBText::_('Activate'); ?></a>
					  		<a href="<?php print $tpl['Template Url']; ?>" class="btn btn-default" target="_blank"><?php print SBText::_('Website'); ?></a>
					  	</div>
					</div>
				</div>
				<?php endforeach; ?>
