...
<form action="" method="post">
	...
	<fieldset>
		...
		<div class="control-group">
			<label><?php print SB_Text::_('Usuario:', 'users'); ?></label>
			<input type="text" name="username" value="" class="form-control" />
		</div>
		<div class="control-group">
			<label><?php print SB_Text::_('Contrase&ntilde;a:', 'users'); ?></label>
		...
		<p class="control-group">
			<button type="submit" id="button-login" class="btn btn-success"><?php print SB_Text::_('Entrar a mi cuenta', 'users'); ?></button>
