...
class LT_AdminControllerContentSection extends SB_Controller
{
	...
	public function task_new()
	{
		...
		sb_set_view_var('title', SB_Text::_('Nueva Seccion', 'content'));
	...
	public function task_edit()
	{
		...
		sb_set_view_var('title', SB_Text::_('Editar Seccion', 'content'));
		...
		$this->document->SetTitle(SBText::_('Editar contenido'));
	}
	public function task_save()
	{
		...
		*/
		...
		if( !$section_id )
		{
			...
			$link = SB_Route::_('index.php?mod=content&view=section.default');
		}
		else 
		{
