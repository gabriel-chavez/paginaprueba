...
$new_link = $type ? SB_Route::_('index.php?mod=content&view=new&type='.$type) : SB_Route::_('index.php?mod=content&view=new'); 
?>
<div class="wrap">
	<h1><?php print $title; ?></h1>
	<ul class="view-buttons">
		<li>
			<a class="btn btn-secondary has-popover" href="<?php print $new_link; ?>" 
	...
	<tr>
		...
		<th><a href="javascript:;"><?php print SB_Text::_('Secciones', 'content'); ?></a></th>
		<th>
