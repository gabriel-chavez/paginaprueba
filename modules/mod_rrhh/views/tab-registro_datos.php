<form id="form-datos" action="" method="post" enctype="multipart/form-data">
	...
	<div class="row">
		<div class="col-xs-12 col-md-6 form-horizontal">
			<div class="form-group">
				<label class="col-sm-3 control-label required"><?php _e('Firstname', 'rrhh'); ?></label>
				<div class="col-sm-9"><input type="text" name="first_name" value="<?php print isset($person) ? $person->first_name : ''; ?>" class="form-control required" /></div>
			</div>
			<div class="form-group">
				<label class="col-sm-3 control-label required"><?php _e('Fathers Name', 'rrhh'); ?></label>
				<div class="col-sm-9"><input type="text" name="fathers_lastname" value="<?php print isset($person) ? $person->fathers_lastname : ''; ?>" class="form-control required" /></div>
			</div>
			<div class="form-group">
				<label class="col-sm-3 control-label required"><?php _e('Mothers Name', 'rrhh'); ?></label>
				<div class="col-sm-9"><input type="text" name="mothers_lastname" value="<?php print isset($person) ? $person->mothers_lastname : ''; ?>" class="form-control required" /></div>
			</div>
			<div class="form-group">
				<label class="col-sm-3 control-label required"><?php _e('Birth Date', 'rrhh'); ?></label>
				<div class="col-sm-9"><input type="text" name="birthday" data-date-end-date="0d" 
					value="<?php print isset($person) ? sb_format_date($person->birthday) : ''; ?>" 
					class="form-control datepicker required" />
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-3 control-label required"><?php _e('Place of birth', 'rrhh'); ?></label>
				<label class="col-sm-2 control-label required"><?php _e('City', 'rrhh'); ?></label>
				<div class="col-sm-2"><input type="text" name="city_birth" value="<?php print isset($person) ? $person->city_birth : ''; ?>" class="form-control required" /></div>
				<label class="col-sm-2 control-label"><?php _e('Country', 'rrhh'); ?></label>
				<div class="col-sm-3"><?php sb_dropdown_countries(array('id' => 'country_birth', 'selected' => isset($person) ? $person->country_birth : '-1', 'class' => 'form-control required')); ?></div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				<label class="col-sm-3 control-label required"><?php _e('Telephone', 'rrhh'); ?></label>
				<div class="col-sm-3"><input type="text" name="telephone" value="<?php print isset($person) ? $person->telephone : ''; ?>" class="form-control required" /></div>
			...
			<div class="form-group">
				<label class="col-sm-3 control-label required"><?php _e('Email', 'rrhh'); ?></label>
				<div class="col-sm-9"><input type="email" name="email" value="<?php print isset($person) ? $person->email : ''; ?>" class="form-control required" /></div>
			</div>
			<div class="form-group">
				<label class="col-sm-3 control-label required"><?php _e('Document Type', 'rrhh'); ?></label>
			...
			<div class="form-group">
				<label class="col-sm-3 control-label required"><?php _e('Document Number', 'rrhh'); ?></label>
				<div class="col-sm-4"><input type="text" name="document" value="<?php print isset($person) ? $person->document : ''; ?>" class="form-control required" /></div>
			...
			<div class="form-group">
				...
				<div class="row">
					<div class="col-xs-12 col-md-3">
						...
						<input type="hidden" id="adjunto" name="adjunto" value="si" />
						<?php else: ?>
						<img src="<?php print BASEURL; ?>/images/nobody.png" class="thumbnail" />
						<input type="hidden" id="adjunto" name="adjunto" value="no" />
						<?php endif;?>
					</div>
				...
				<div class="col-xs-12 col-md-12">
					<div class="alert alert-info">
						Debe adjuntar una fotografía en traje formal con fondo blanco
					</div>
				</div>
			</div>
		</div>
