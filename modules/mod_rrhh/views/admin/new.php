...
<div class="wrap">
	<h2><?php print $title; ?>
		<span class="pull-right">
			<a href="<?php print SB_Route::_('index.php?mod=rrhh')?>" class="btn btn-danger"><?php _e('Back', 'rrhh'); ?></a>
			<a href="javascript:;" onclick="jQuery('#person-form').submit();" class="btn btn-primary"><?php _e('Save', 'rrhh'); ?></a>
		</span>
	</h2>
	<form id="person-form" action="" method="post">
