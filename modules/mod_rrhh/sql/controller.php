...
class LT_ControllerRrhh extends SB_Controller
{
	...
	public function task_profile()
	{
		...
		if( !$person->id )
		{
			sb_redirect(SB_Route::_('index.php?mod=rrhh&view=login&destroy=1'));
		}
		/*
	...
	public function task_do_register()
	{
		...
		$body = "Hola {$data['username']}<br/><br/>".
				...
				"Usuario: {$data['username']}<br/>".
                                "Palabra clave: {$data['pwd']}<br/>".
				"Email: {$data['email']}<br/><br/>".
				"Sigue el siguiente enlace para poder iniciar sesi&oacute;n en tu cuenta.<br/><br/>".
				"<a href=\"". SB_Route::_('index.php?mod=rrhh&view=login') . "\">Iniciar Sesi&oacute;n</a><br/><br/>".
				"Saludos<br/>".
				SITE_TITLE;
		...
		SB_MessagesStack::AddMessage(__('Your user was registered correctly, please review your email for details', 'rrhh'), 'success');
		sb_redirect($redirect ? $redirect : SB_Route::_('index.php?mod=rrhh&view=login'));
	}
