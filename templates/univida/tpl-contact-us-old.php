...
<!-- <script type="text/javascript" src="http://maps.google.com/maps/api/js?sensor=false&language=es"></script>                                opcion original-->
<!-- <script src="http://maps.google.com/maps?file=api&v=1&key=AlzaSyAvuzfTtHUe7uEVrbzkZoQ9BLQVTHxHDIA" type="text/javascript"></script>     opcion segunda opcion WRZ-->

<!-- <script type="text/javascript" src="http://maps.google.com/maps/api/js?sensor=false&language=es&callback=iniciar"></script>              tercera opcion WRZ -->

<script>
  //var map_location = {lat:<?php print $article->_latitud;?>,lng:<?php print $article->_longitud; ?>,address: '<?php print $article->_address; ?>'};
 function iniciar() {
   var mapOptions = {
      //center: new google.maps.LatLng(<?php print $article->_latitud;?>,<?php print $article->_longitud;?>),
...
<div class="container">
	<!-- <div id="map" data-stellar-background-ratio=".3"></div>            opcion original  -->

        <!--     <div id="map"></div>       Segunda opcion WRZ    -->
</div>
