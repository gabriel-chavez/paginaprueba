		...
		<div class="row">		
			<div class="col-md-4 col-md-offset-4">
				<div class="text-center">
					<a href="<?php print TEMPLATE_URL; ?>/productos.pdf" download="productos.pdf">
						<img src="<?php print TEMPLATE_URL; ?>/images/btndescargapdf.jpg" >
					</a>					
				</div>
			</div>					
		</div>
...
<script src="js/jquery-modal-video.min.js"></script>
	<script>
		...
		$(document).ready(function () {
			$('img[alt="Concurso_UIF"]').css("cursor", "pointer");
			//$('#video_uif').attr('data-channel', 'video').attr('data-video-url', 'images/1_er_concurso_uif.mp4')
			$('img[alt="Concurso_UIF"]').click(function() {
				//alert('holoa')
				$('#video_uif').trigger( "click" );
			});
			$('#video_uif').trigger( "click" );
			// $('img[alt="Concurso_UIF"]').attr('data-channel', 'video').attr('data-video-url', 'images/1_er_concurso_uif.mp4').addClass('js-video-button')
			
			//data-channel="video" data-video-url="images/1_er_concurso_uif.mp4"
		});
	</script>