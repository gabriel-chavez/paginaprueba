 <?php
 $tel="(591-2) 2151000";
 $dir="Av. Camacho, esquina Calle Bueno, N° 1485<br> Edificio La Urbana, piso 3.";
 ...
 <section class="content">
        <div class="contentCnt">
           ...
           <p class="tituloFooter"><b>Líneas gratuitas: &nbsp; UNIVida: 800-10-9119  &nbsp;|  &nbsp;FISO: 800-10-8999</b></p>
            <p class="tituloFooter">"Atendemos las 24 horas, los 7 días de la semana."</p>
        </div>
        </section>

        <section class="inf">
        <div class="cntInf ">
            <p class="tituloFooter">
            ...
            <p class="pAL">
                ...
                <br>
                <br>
                <span class="color2">Email:</span> <a href="mailto:info@univida.bo" class="lnk2"><?php echo $mail ?></a><br>
                <span class="color2"><?php echo $tel ?> </span>
            </p>
